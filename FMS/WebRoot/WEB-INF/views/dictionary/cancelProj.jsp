...
<meta http-equiv="X-UA-Compatible" content="edge" />
	...
	{
		if(buttonList[i].id=='BT0501050')
		{
			$.canAdd=true;
		}
		else if(buttonList[i].id=='BT0501051')
		{
			$.canDelete=true;
		}
		else if(buttonList[i].id=='BT0501052')
		{
			$.canImport=true;
		}
		else if(buttonList[i].id=='BT0501053')
		{
			$.canEdit=true;
		}
	}
	     ...
	     <form id="editForm" enctype="multipart/form-data" method="post">
			<table class="grid">
				<tr>
					...
					<td><input id="project_code_edit" name="account_code_edit" style="width:200px;" type="text" disabled="disabled"></td>	
				</tr>
				<tr>
					<td nowrap>项目名称:</td>
					<td><input id="project_name_edit" name="account_name_edit" style="width:200px;" type="text" placeholder="请输入科目名称" class="easyui-validatebox" data-options="required:true" value="" maxlength="50"></td>	
				</tr>
			</table>
		</form>
     </div>
	    ...
	    <div id="importDialog" style="height:200px;width:400px;" class="easyui-dialog" 
	     ...
	     <form id="importForm" enctype="multipart/form-data" method="post">
			<table class="grid">
				<tr>
					<td nowrap>销项上传:
					 <input id="tableName" name="tableName" type="hidden" value="t_cancel_proj"/>
					</td>
