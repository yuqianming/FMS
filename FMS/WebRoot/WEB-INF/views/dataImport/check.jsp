...
<meta http-equiv="X-UA-Compatible" content="edge" />
	<script type="text/javascript">
		...
		{
            if(buttonList[i].id=='BT02020')
			{
				$.canImport=true;
			}
            else if(buttonList[i].id=='BT02021')
			{
				$.canExport=true;
			}
		}
...
<title></title>
	...
	$(function() {
		...
		dataGrid = $('#dataGrid').datagrid({
			...
			title:"入库信息列表",  
			columns : [[
              {width : '100',title : '日期',field : 'entry_date',sortable : true,align:'center'},
              {width : '150',title : '凭证编号',field : 'voucher_no',sortable : true,align:'center'},
              {width : '180',title : '入库单号',field : 'entry_code',sortable : true,align:'center'},
              {width : '250',title : '采购订单号',field : 'order_code',sortable : true,align:'center'},
              {width : '120',title : '金额',field : 'amount',sortable : true,align:'right'},
...
<div style="display:none"><form id="export" method="post"></form></div>
    <div id="importDialog" style="height:200px;width:400px;" class="easyui-dialog" 
	     ...
	     <form id="importForm" enctype="multipart/form-data" method="post">
			<table class="grid">
				<tr>
					<td nowrap>入库上传:
					 <input id="tableName" name="tableName" type="hidden" value="t_godown_entry"/>
	...
	<div data-options="region:'center',fit:false,border:false">
		<table id="dataGrid" data-options="fit:true,border:false,toolbar:'#tb'" class="easyui-datagrid"></table>
	</div>
