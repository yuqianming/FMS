...
<!-- [EasyUI] -->
<link id="easyuiTheme" rel="stylesheet" href="${ctx}/jslib/easyui1.4.2/themes/default/easyui.css" type="text/css">
...
<!-- [导入JS] -->
<script type="text/javascript" src="${ctx}/jslib/import.js" charset="utf-8"></script>
<!-- [扩展fms样式] -->
<link rel="stylesheet" href="${ctx}/style/css/fms.css" type="text/css">
<!-- [扩展fms的JS] -->
<script type="text/javascript" src="${ctx}/style/js/fms.js" charset="utf-8"></script>