...
<meta http-equiv="X-UA-Compatible" content="edge" />
	...
	{
		if(buttonList[i].id=='BT0501010')
		{
			$.canAdd=true;
		}
		else if(buttonList[i].id=='BT0501011')
		{
			$.canDelete=true;
		}
		else if(buttonList[i].id=='BT0501012')
		{
			$.canImport=true;
		}
		else if(buttonList[i].id=='BT0501013')
		{
			$.canEdit=true;
		}
	}
...
<title></title>
	...
	$(function() {
		...
		dataGrid = $('#dataGrid').datagrid({
			...
			onDblClickRow:function(index,row)
			{
				...
				{
					$("#id").val(row.id);
					$("#account_code_edit").val(row.account_code);
					$("#account_name_edit").val(row.account_name);
	...
	function editFun()
	{
		...
		$.ajax({
			type : "POST", //提交方式  
			url : "${ctx}/account/edit",//路径  
			//dataType : "json",
			data : {
				id:$("#id").val(),
				account_code:$("#account_code_edit").val(),
...
<body class="easyui-layout" data-options="fit:true,border:false" ondragstart='return false'>
	 ...
	 <div id="addDialog" style="height:200px;width:400px;" class="easyui-dialog" 
	     ...
	     <form id="addForm" enctype="multipart/form-data" method="post">
			<table class="grid">
				<tr>
					<td nowrap>科目代码:</td>
					<td><input id="account_code" name="account_code" style="width:200px;" type="text" placeholder="请输入科目代码" class="easyui-validatebox" data-options="required:true" value="" maxlength="10"></td>	
				</tr>
				<tr>
					<td nowrap>科目名称:</td>
					<td><input id="account_name" name="account_name" style="width:200px;" type="text" placeholder="请输入科目名称" class="easyui-validatebox" data-options="required:true" value="" maxlength="50"></td>	
				</tr>
			</table>
		</form>
     </div>
     ...
     <div id="editDialog" style="height:200px;width:400px;" class="easyui-dialog" 
	     ...
	     <form id="editForm" enctype="multipart/form-data" method="post">
			<table class="grid">
				<tr>
					<td nowrap>科目代码:<input id="id" name="id" type="hidden"></td>
					<td><input id="account_code_edit" name="account_code_edit" style="width:200px;" type="text" placeholder="请输入科目代码" class="easyui-validatebox" data-options="required:true" value="" maxlength="10"></td>	
				</tr>
				<tr>
					<td nowrap>科目名称:</td>
					<td><input id="account_name_edit" name="account_name_edit" style="width:200px;" type="text" placeholder="请输入科目名称" class="easyui-validatebox" data-options="required:true" value="" maxlength="50"></td>	
				</tr>
			</table>
		</form>
     </div>
	    ...
	    <div id="importDialog" style="height:200px;width:400px;" class="easyui-dialog" 
	     ...
	     <form id="importForm" enctype="multipart/form-data" method="post">
			<table class="grid">
				<tr>
					<td nowrap>科目上传:
					 <input id="tableName" name="tableName" type="hidden" value="t_account"/>
					</td>
